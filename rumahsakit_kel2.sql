...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 16, 2025 at 02:48 PM
...
CREATE TABLE `tabel dokter` (
  ...
  `Nama Dokter` varchar(25) NOT NULL,
  `JK Dokter` varchar(20) NOT NULL,
  `Gelar/Spesialis` varchar(25) NOT NULL
...
('WNR72', 'Dr.Retno Widjaja,Sp.PD', 'Perempuan', 'Sp.Penyakit Dalam'),
...
CREATE TABLE `tabel pasien` (
  ...
  `Nama Pasien` varchar(15) NOT NULL,
  `No.Telpn` varchar(20) NOT NULL,
...
CREATE TABLE `tabel pendaftaran pasien` (
  ...
  `Nama Pendaftar` varchar(15) NOT NULL,
...
CREATE TABLE `tabel rekam medis` (
  `No.RM` varchar(10) NOT NULL,
  `Kode Dokter` varchar(10) NOT NULL,
  `Tgl. Periksa Pasien` date NOT NULL,
  `Diagnosa Dokter` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tabel transaksi` (
  ...
  `Jmlh. Pembayaran` varchar(16) NOT NULL,
